ruleset {
    ...
    // More often that not, assertions are happening with a framework or mock library
    // and codenarc doesn't see it
    ...
    FieldName
    InterfaceName
    MethodName(ignoreMethodNames: "should*")
    ...
    //same as 'regex'
    VariableName(finalRegex: '[a-z][a-zA-Z0-9_]*')
    ...
    // We don't need any of these checks since we don't use writeObject.
